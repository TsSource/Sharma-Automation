...
<div className="mobile-menu" style={{
  display: "none",
  position: "fixed", top: headerHeight, left: 0, right: 0, zIndex: 101,
  ...
  <button className="btn-primary" onClick={() => { window.open('https://calendly.com/sharma-sharmaautomation/30min', '_blank'); setMenuOpen(false); }} style={{ marginTop: 16, padding: "14px", fontSize: 15, textAlign: "center" }}>
    Book Free Call
      ...
      <section style={{
        ...
        padding: `${headerHeight}px 5vw 80px`,
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", width: "100%" }}>
          <div style={{ maxWidth: 680 }}>
            ...
            <h1 className="playfair" style={{ fontSize: "clamp(32px, 8vw, 66px)", fontWeight: 700, lineHeight: 1.1, letterSpacing: "-1px", marginBottom: 24, color: s.navy }}>
              Put Your Business<br />
              <span style={{ color: s.accent }}>On Autopilot</span>{" "}
              With AI.
            </h1>
            <p className="dm hero-sub" style={{ fontSize: 18, color: s.mid, lineHeight: 1.75, marginBottom: 40, maxWidth: 520, fontWeight: 300 }}>
